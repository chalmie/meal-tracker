...
export class AppComponent {
  public entries: Entry[];  // Entry[] (or Array<Entry>) identifies entries as an array of Entry objects
  constructor(){
    this.entries = [
  ...
  entryWasSelected(clickedEntry: Entry): void {
    console.log('Parent', clickedEntry);
  }
}
